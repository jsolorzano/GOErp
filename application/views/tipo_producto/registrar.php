...
//~ 
                ...
                $("#tipo_producto").change(function (event) {
                    ...
                    $.post('<?php echo base_url(); ?>index.php/tipo_producto/ControllersTipoProducto/consultar/', $('#form_tipoproducto').serialize(), function (response) {
						//~ alert(response[0])
						if (response[0] == 'e') {
                ...
                $("#registrar").click(function (e) {
                    ...
                    //~ }
                         ...
                         $.post('<?php echo base_url(); ?>index.php/tipo_producto/ControllersTipoProducto/guardar', $('#form_tipoproducto').serialize(), function (response) {
                        ...
                        <div class="col-lg-12">
                            <div class="well bs-component">
                                ...
                                <form class="form-horizontal" id="form_tipoproducto">
                                    <fieldset>
                                        <legend>Registrar Tipo de Producto</legend>
                                           <br/>
                                        <div class="form-group">
                                            <div class="col-xs-1" style="font-weight:bold">Código</div>
                                            <div class="col-lg-5">
                                                <input class="form-control" autofocus="" value="<?php printf('TP' . "%05d", (int)$ultimo_id + (int)1); ?>" type='text' placeholder="TC00001" id="cod_tipo" maxlength="7" name="cod_tipo" readonly="true"/>
                                            </div>
                                           <div class="col-xs-1" style="font-weight:bold" >Descripción</div>
                                            <div class="col-lg-5">
                                               	<input class="form-control" type='text' placeholder="Descripción del Tipo de Producto" maxlength="100" id="tipo_producto" name="tipo_producto"/>
                                            </div>
