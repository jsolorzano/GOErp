...
$this->pdf->Cell(185,5,"Inventario de Productos Disponibles",'T',1,'C',1);
...
$this->pdf->Cell(35,5,"Nombre del Producto",'B',0,'L',1);
$this->pdf->Cell(30,5,"Stock Disponible",'B',0,'L',1);
$this->pdf->Cell(30,5,utf8_decode("Stock Máximo"),'B',0,'L',1);
$this->pdf->Cell(30,5,utf8_decode("Stock Mínimo"),'B',0,'L',1);
$this->pdf->Cell(30,5,"Precio Base (Bs)",'B',1,'R',1);
//~ $this->pdf->Cell(20,5,"Importe",'B',1,'R',1);

foreach ($productos as $productos){
	//~ $this->pdf->Ln(5);
	$this->pdf->Cell(30,5,"$productos->codigo",'',0,'C',1);
	$this->pdf->Cell(35,5,utf8_decode("$productos->nombre"),'',0,'L',1);
	$this->pdf->Cell(30,5,"$productos->existencia",'',0,'L',1);
	$this->pdf->Cell(30,5,"$productos->stock_max",'',0,'L',1);
	$this->pdf->Cell(30,5,"$productos->stock_min",'',0,'L',1);
	$this->pdf->Cell(30,5,"$productos->precio_total",'',1,'R',1);
	#~ j = j + 10
}
