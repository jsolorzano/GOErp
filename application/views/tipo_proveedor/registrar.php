...
//~ 
                ...
                $("#tipo_proveedor").change(function (event) {

                    var tipo_proveedor = $('#tipo_proveedor').val();
                    $.post('<?php echo base_url(); ?>index.php/tipo_proveedor/ControllersTipoProveedor/consultar/', $('#form_tipoproveedor').serialize(), function (response) {
						//~ alert(response[0])
						if (response[0] == 'e') {
							bootbox.alert("El tipo de proveedor ya existe", function () {
                ...
                $("#registrar").click(function (e) {
                    ...
                    //~ }
                         ...
                         $.post('<?php echo base_url(); ?>index.php/tipo_proveedor/ControllersTipoProveedor/guardar', $('#form_tipoproveedor').serialize(), function (response) {
                                ...
                                <form class="form-horizontal" id="form_tipoproveedor">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-5">
                                                <input class="form-control" autofocus="" value="<?php printf('TP' . "%05d", (int)$ultimo_id + (int)1); ?>" type='text' placeholder="TP00001" id="cod_tipo" maxlength="7" name="cod_tipo" readonly="true"/>
                                            </div>
                                           <div class="col-xs-1" style="font-weight:bold" >Descripción</div>
                                            <div class="col-lg-5">
                                               	<input class="form-control" type='text' placeholder="Descripción del Tipo de Proveedor" maxlength="100" id="tipo_proveedor" name="tipo_proveedor"/>
                                            </div>
