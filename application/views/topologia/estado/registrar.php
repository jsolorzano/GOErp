    ...
    redirect(base_url());
        ...
        <script>
            $(document).ready(function () {
                ...
                $("select").select2();
                $("#cedula").numeric(); //Sólo permite valores numericos
                ...
                $("#registrar").click(function (e) {
                    ...
                    if (($('#cod_estado').val().trim() == '')) {
                        ...
                        bootbox.alert('Disculpe, Nombre de estado invalido (Muy Corto)', function() {	    
                         ...
                         $.post('<?php echo base_url(); ?>index.php/topologia/ControllersEstado/guardar', $('#form_estado').serialize(), function (response) {
                                ...
                                <form class="form-horizontal" id="form_estado">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-5">
                                                <input class="form-control" autofocus="" type='text' id="cod_estado" name="cod_estado" value="<?php echo (int)$ultimo_id + (int)1; ?>" readonly="true"/>
                                            </div>
