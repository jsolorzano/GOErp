...
//            alert($('#id_servicio').val());
            ...
            if ($('#id_servicio').val() == null || $('#id_servicio').val() == 0) {
				...
				if( id!='' & precioventa!='' & producto!='' & cantidad!='' ){
					...
					// Ejecución de los cálculos de la presupuesto
...
//
        ...
        $("#presupuestar").click(function (e) {
            ...
            campo7 = String($("#codpresupuesto").val().trim());
                ...
                campos = {"id" : campo1, "id_servicio" : campo2, "precio" : campo3, "monto_iva" : campo4, "cantidad" : campo5, "importe" : campo6, "cod_presupuesto" : campo7},
                data.push(campos);                
            ...
            //~ }, 'json')
				...
				$.post('<?php echo base_url(); ?>index.php/presupuesto/ControllersPresupuesto/guardar/', $('#form_presupuesto').serialize()+'&'+$.param({'data':data}), function (response) {
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="f_nueva_venta" action="" method="post" class="form">
                    ...
                    <p>
                        <label>Precio:</label><br clear="all"> <input type="text" style="width:100%" class="form-control" id="precio" name="precio" readonly="true">
                    </p>
                    <p>
...
<!--
                                ...
                                <?php
									// Construcción del código de la presupuesto para mostrar en el encabezado (Todo lo comentado es la versión anterior)
									//~ $pre_cod = "00";
									if((int)$ultimo_id + (int)1 == 1){
										//~ printf("$pre_cod %08d", (int)$ultimo_id + (int)1);
										printf("%08d", (int)$ultimo_id + (int)1);
									}else{
										//~ $c_presupuesto = (int)substr($cod_presupuesto->codpresupuesto, 2);
										$c_presupuesto = (int)$cod_presupuesto->codpresupuesto;
										//~ $pre_cod = $cod_presupuesto->pre_cod_presupuesto;
										
										if ($c_presupuesto + (int)1 > 99999999){
											//~ printf("%02d %08d",($pre_cod+1), 1);
											printf("%08d", 1);
										}else{
											printf("%08d", $c_presupuesto + (int)1);
										}
									}
								?>
                                )</legend>
-->
                                <input type="hidden" id="codpresupuesto" name="codpresupuesto" value="
                                <?php
									// Construcción del código de la presupuesto para mostrar en el campo de cod_presupuesto (Todo lo comentado es la versión anterior)
									//~ $pre_cod = "00";
									if((int)$ultimo_id + (int)1 == 1){
										//~ printf(trim("$pre_cod%08d"), (int)$ultimo_id + (int)1);
										printf(trim("%08d"), (int)$ultimo_id + (int)1);
									}else{
										//~ $cod_presupuesto = (int)$cod_presupuesto->codpresupuesto;
										if ($c_presupuesto + (int)1 > 99999999){
											//~ $pre_cod = (int)$cod_presupuesto->pre_cod_presupuesto + (int)1;
											//~ printf("%02d%08d",$pre_cod, 1);
											printf("%08d", 1);
										}else{
											//~ $pre_cod = (int)$cod_presupuesto->pre_cod_presupuesto;
											//~ printf("%02d%08d",$pre_cod, $c_presupuesto + (int)1);
											printf("%08d", $c_presupuesto + (int)1);
										}
									}
								?>
                                ">
                                <input type="hidden" id="pre_cod_presupuesto" name="pre_cod_presupuesto" value="
                                <?php
									// Construcción del pre-código de la presupuesto para mostrar en el campo de pre_cod_presupuesto (Todo lo comentado es la versión anterior)
									//~ $pre_cod = "00";
									//~ if((int)$ultimo_id + (int)1 == 1){
										//~ print trim($pre_cod);
									//~ }else{
										//~ if ((int)$c_presupuesto + (int)1 > 99999999){
											//~ $pre_cod = (int)$cod_presupuesto->pre_cod_presupuesto + (int)1;
											//~ printf("%02d", $pre_cod);
										//~ }else{
											//~ $pre_cod = (int)$cod_presupuesto->pre_cod_presupuesto;
                            ...
                            <div class="col-sm-5">
								<div style="margin-left: 0.2%;margin-bottom: -1%;" class="form-group">
									...
									<div class="input-group mar-btm">
										...
										<input type="text" style="width: 20%;" readonly="true" name="codcliente" id="codcliente" class="form-control">
										<input type="text" style="width: 80%;" name="cliente" id="cliente" placeholder="Cliente" class="form-control">
										<span class="input-group-btn">
...
-->
                            <div class="col-sm-1">
								<span >Descuento</span>
								<div class="input-group mar-btm">
									<input type="text" style="width:100%;" data-original-title="Descuento" data-toggle="tooltip" data-placement="bottom" name="descuento" id="descuento" placeholder="0.00" class="form-control add-tooltip" maxlength="3">
...
<!--                            <div class="row" style="text-align: center">
                    ...
                    <div class="row" style="text-align: center">
                        ...
                        <div class="col-sm-2">
                            <h4 style="margin-top: 5px;color:#D3220E">
                                BI G: <span id="span_bi"></span>
                            </h4>   
                        </div>
                        <div class="col-sm-2">
                            <h4 style="margin-top: 5px;color:#D3220E">
                                BI E: <span id="span_bi_e"></span>
                            </h4>   
                        </div>
                    </div>
                    ...
                    <div class="container-fluid" style="margin-top: 10px;">
                        <div class="row">
							<input type="hidden" id="base_imponible" name="base_imponible" placeholder="Base Imponible">
							<input type="hidden" id="monto_exento" name="monto_exento" placeholder="Exento">
							<input type="hidden" id="monto_desc" name="monto_desc" placeholder="Descuento">
							<input type="hidden" id="monto_iva" name="monto_iva" placeholder="IVA">
							<input type="hidden" id="subtotal" name="subtotal" placeholder="Sub-Total Presupuesto">
							<input type="hidden" id="totalpresupuesto" name="totalpresupuesto" placeholder="Total presupuesto">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    Observaciones:
