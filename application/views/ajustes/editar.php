...
$(document).ready(function () {
	...
	// Carga de valores de los combo select
	$('#iva').val($('#id_iva').val());
	$('#tipo_ajuste').val($('#id_tipoajuste').val());
		...
		if ($('#subtotal').val().trim() == '' || $("#totalajuste").val().trim() == '' || $('#subtotal').val().trim() == 0 || $("#totalajuste").val().trim() == 0) {
			...
			if ($("#tipo_ajuste").val() == '2'){
				...
				if(parseFloat($("#totalajuste").val()) <= parseFloat($("#totalfactura").val())){
					$.post('<?php echo base_url(); ?>index.php/ajustes/ControllersAjustes/actualizar/', $('#form_ajustes').serialize(), function (response) {
	...
	//~ 
	// Procedimiento para la carga de los datos de la factura seleccionada al cargar la página
                ...
                <form id="form_ajustes" class="form" method="post">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-12">
<!--
                                <legend>Ajuste (<?php echo $editar->codajuste;?>)</legend>
-->
                                <input type="hidden" id="codajuste" name="codajuste" value="<?php echo $editar->codajuste;?>">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-5">
								<div style="margin-left: 0.2%;margin-bottom: -1%;" class="form-group">
									...
									<div class="input-group mar-btm">
										...
										<input type="text" style="width: 18%;" name="codfactura" id="codfactura" class="form-control" readonly="true" value="<?php echo $editar->codfactura;?>">
										<input type="text" style="width: 22%;" name="rifcliente" id="rifcliente" placeholder="RIF Cliente" class="form-control" readonly="true" value="<?php echo $editar->rifcliente;?>">
										<input type="text" style="width: 60%;" name="cliente" id="cliente" placeholder="Cliente" class="form-control" readonly="true" value="<?php echo $editar->cliente;?>">
										<span class="input-group-btn">
                            ...
                            <div class="col-sm-2">
								...
								<div class="input-group mar-btm">
										...
										<input type="text" data-original-title="Fecha Emision" value="<?php echo $editar->fecha_ajuste; ?>" data-toggle="tooltip" data-placement="bottom" readonly="true" name="fecha_ajuste" id="fecha_ajuste" placeholder="Fecha Emisión" class="form-control add-tooltip">
								</div>
                            </div>
							<div class="col-sm-1">
								<span >IVA</span>
                        ...
                        <div class="row">
                            <div class="col-sm-2">
								...
								<div class="input-group mar-btm">
									<input type="text" style="width: 100%;" name="base_imponible" id="base_imponible" placeholder="000.00" class="form-control" value="<?php echo $editar->base_imponible;?>">
								</div>
                            </div>
                            <div class="col-sm-2">
								<span >Monto IVA</span>
								<div class="input-group mar-btm">
									<input type="text" style="width: 100%;" id="monto_iva" name="monto_iva" class="form-control" readonly="true" value="<?php echo $editar->monto_iva;?>">
								</div>
                            </div>
							<div class="col-sm-2">
								<span >Monto Exento</span>
								<div class="input-group mar-btm">
									<input type="text" style="width: 100%;" id="monto_exento" name="monto_exento" placeholder="000.00" class="form-control" value="<?php echo $editar->monto_exento;?>">
								</div>
                            </div>
                            <div class="col-sm-2">
								<span >Sub-total</span>
								<div class="input-group mar-btm">
									<input type="text" style="width: 100%;" id="subtotal" name="subtotal" placeholder="000.00" class="form-control" readonly="true" value="<?php echo $editar->subtotal;?>">
								</div>
                            </div>
                            <div class="col-sm-2">
								<span >Ajuste Total</span>
								<input type="text" style="width: 100%;" id="totalajuste" name="totalajuste" placeholder="000.00" class="form-control" readonly="true" value="<?php echo $editar->totalajuste;?>">
                            </div>
                    ...
                    <div class="container-fluid" style="margin-top: 10px;">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    Concepto:
                                    <textarea class="form-control" id="concepto" name="concepto" rows="3" style="width:100%"><?php echo $editar->concepto;?></textarea>
                                    <input type="hidden" id="totalfactura">
                                    <input type="hidden" id="id_iva" value="<?php echo $editar->iva;?>">
                                    <input type="hidden" id="id_tipoajuste" value="<?php echo $editar->tipo_ajuste;?>">
                                </div>
                            </div>
                            <br/>
