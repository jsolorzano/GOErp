...
//~ 
                ...
                $("#registrar").click(function (e) {
                    ...
                    //~ }
                         ...
                         $.post('<?php echo base_url(); ?>index.php/cargos/ControllersCargos/actualizar', $('#form_cargo').serialize(), function (response) {
                                ...
                                <form class="form-horizontal" id="form_cargo">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-5">
                                                <input class="form-control" autofocus="" readonly="" type='text' placeholder="Ej: 8" id="cod_cargo" value="<?php echo $editar[0]->cod_cargo?>" maxlength="7" name="cod_cargo"/>
                                            </div>
                                           <div class="col-xs-1" style="font-weight:bold">Descripción</div>
                                            <div class="col-lg-5">
                                               	<input class="form-control"  type='text' placeholder="Nombre del Cargo" maxlength="100" value="<?php echo $editar[0]->cargo?>" id="cargo" name="cargo"/>
                                            </div>
