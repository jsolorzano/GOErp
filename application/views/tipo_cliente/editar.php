...
//~ 
                ...
                $("#registrar").click(function (e) {
                    ...
                    //~ }
                         ...
                         $.post('<?php echo base_url(); ?>index.php/tipo_cliente/ControllersTipoCliente/actualizar', $('#form_tipocliente').serialize(), function (response) {
                        ...
                        <div class="col-lg-12">
                            <div class="well bs-component">
                                ...
                                <form class="form-horizontal" id="form_tipocliente">
                                    <fieldset>
                                        <legend>Editar Tipo de Cliente</legend>
                                           <br/>
                                        <div class="form-group">
                                           ...
                                           <div class="col-xs-1" style="font-weight:bold">Descripción</div>
                                            <div class="col-lg-5">
                                               	<input class="form-control"  type='text' placeholder="Nombre del Tipo de Cliente" maxlength="100" value="<?php echo $editar[0]->tipo_cliente?>" id="tipo_cliente" name="tipo_cliente"/>
                                            </div>
