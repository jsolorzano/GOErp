    ...
    redirect(base_url());
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#origen").select2('val',$("#id_origen").val());
                $("#destino").select2('val',$("#id_destino").val());
                ...
                // Mostrar el saldo disponible de la cuenta de origen al cargar la página
                    ...
                    if (($('#monto').val().trim() == '')) {
						...
						$.post('<?php echo base_url(); ?>index.php/transferencias/ControllersTransferencias/consultar/', $('#form_transferencia').serialize(), function (response) {
							...
							if (parseFloat(respuesta[0]) < $("#monto").val()) {
								...
								$.post('<?php echo base_url(); ?>index.php/transferencias/ControllersTransferencias/actualizar', $('#form_transferencia').serialize(), function (response) {
                        ...
                        <div class="col-lg-12">
                            <div class="well bs-component">
                                ...
                                <form class="form-horizontal" id="form_transferencia">
                                    <fieldset>
                                        <legend>Editar transferencia</legend>
                                           <br/>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-5">
                                                <input class="form-control" type='text' id="monto" name="monto" value="<?php echo $editar[0]->monto; ?>"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-12">
                                                ...
                                                <input class="form-control"  type='hidden' id="id_origen" value="<?php echo $editar[0]->origen; ?>"/>
                                                <input class="form-control"  type='hidden' id="id_destino" value="<?php echo $editar[0]->destino; ?>"/>
