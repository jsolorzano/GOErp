...
//            alert($('#id_servicio').val());
	...
	$("#facturar").click(function (e) {
		...
		campo7 = String($("#codfactura").val().trim());
			...
			campos = {"id" : campo1, "id_servicio" : campo2, "precio" : campo3, "monto_iva" : campo4, "cantidad" : campo5, "importe" : campo6, "cod_factura" : campo7},
			data.push(campos);                
		...
		//~ }, 'json')
			...
			$.post('<?php echo base_url(); ?>index.php/factura/ControllersFacturar/guardar/', $('#form_factura').serialize()+'&'+$.param({'data':data}), function (response) {
...
<!--
                                ...
                                <?php
									...
									if((int)$ultimo_id + (int)1 == 1){
										...
										//~ $c_factura = (int)substr($cod_factura->codfactura, 2);
										$c_factura = (int)$cod_factura->codfactura;
										...
										if ($c_factura + (int)1 > 99999999){
											...
											printf("%08d", $c_factura + (int)1);
										}
									}
								?>
                                )</legend>
-->
                                <input type="hidden" id="codfactura" name="codfactura" value="
                                <?php
                                ...
                                <?php
									...
									//~ if((int)$ultimo_id + (int)1 == 1){
										//~ print trim($pre_cod);
									//~ }else{
										//~ if ((int)$c_factura + (int)1 > 99999999){
											//~ $pre_cod = (int)$cod_factura->pre_cod_factura + (int)1;
											//~ printf("%02d", $pre_cod);
										//~ }else{
											//~ $pre_cod = (int)$cod_factura->pre_cod_factura;
...
-->
                    ...
                    <div class="row" style="text-align: center">
                        ...
                        <div class="col-sm-2">
                            <h4 style="margin-top: 5px;color:#D3220E">
                                Nota de Crédito: <span id="span_credito"></span>
                            </h4>   
                        </div>
                        <div class="col-sm-2">
                            <h4 style="margin-top: 5px;color:#D3220E">
                                Nota de Débito: <span id="span_debito"></span>
                            </h4>   
                        </div>
                    </div>
                    ...
                    <div class="container-fluid" style="margin-top: 10px;">
                        <div class="row">
							...
							<input type="hidden" id="nota_credito" name="nota_credito" placeholder="Nota de crédito">
							<input type="hidden" id="nota_debito" name="nota_debito" placeholder="Nota de débito">
							<input type="hidden" id="subtotal" name="subtotal" placeholder="Sub-Total Factura">
							<input type="hidden" id="totalfactura" name="totalfactura" placeholder="Total Factura">
							<input type="hidden" id="ajustes" name="ajustes" placeholder="Ajustes">
							<input type="hidden" id="condicion_pago" name="condicion_pago" placeholder="Condiciones">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    Observaciones:
