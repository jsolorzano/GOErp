                ...
                $("#registrar").click(function (e) {
                    ...
                    if (($('#nombre').val().trim() == '')) {
                        ...
                        bootbox.alert('Disculpe, Debe Colocar el valor del Impuesto del Valor Agregado', function() {
                         ...
                         $.post('<?php echo base_url(); ?>index.php/impuesto/ControllersImpuesto/actualizar', $('#form_estado').serialize(), function (response) {
                        ...
                        <div class="col-lg-12">
                            <div class="well bs-component">
                                ...
                                <form class="form-horizontal" id="form_estado">
                                    <fieldset>
                                        <legend>Editar Impuesto del Valor Agregado</legend>
                                           <br/>
                                        <div class="form-group">
                                            <label class="col-lg-1 control-label" style="font-weight:bold">Código</label>
                                                <div class="col-lg-3">
                                                    ...
                                                    <input class="form-control" autofocus="" readonly="" type='text'  id="codigo" value="<?php echo $editar[0]->codigo?>" maxlength="20" name="codigo"/>
                                                                                                      
                                                </div>
                                            <div class="col-xs-1" style="font-weight:bold" >Nombre</div>
                                            <div class="col-lg-3">
                                                <input class="form-control" autofocus=""  type='text'  id="nombre" value="<?php echo $editar[0]->nombre?>" maxlength="20" name="nombre"/>
                                            </div>
                                           <div class="col-xs-1" style="font-weight:bold">Valor</div>
                                            <div class="col-lg-3">
                                               	<input class="form-control"  type='text' placeholder="Nombre del Estado" maxlength="20" value="<?php echo $editar[0]->valor?>" id="valor" name="valor"/>
                                            </div>
